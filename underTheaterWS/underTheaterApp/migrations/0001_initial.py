# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-30 21:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_show', models.DateTimeField(auto_now=True, verbose_name='dia y horario del show')),
            ],
        ),
        migrations.CreateModel(
            name='PlayPrice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(to='underTheaterApp.Actor', verbose_name='categor\xedas')),
            ],
        ),
        migrations.CreateModel(
            name='TheaterRoom',
        ...
        migrations.AddField(
            ...
            name='play',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='play_price', to='underTheaterApp.PlayTheater', verbose_name='PlayPrice'),
        ),
        migrations.AddField(
            model_name='dateshow',
            name='play',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='play_date_show', to='underTheaterApp.PlayTheater', verbose_name='date show'),
        ),
        migrations.AddField(
            model_name='contact',
            name='address',
        ...
        migrations.AddField(
            ...
            name='theater',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theater_room', to='underTheaterApp.Theater', verbose_name='room'),
        ),
        migrations.AddField(
            model_name='playtheater',
            name='theater',
            field=models.ManyToManyField(related_name='theater', to='underTheaterApp.Theater', verbose_name='play'),
        ),
    ]
